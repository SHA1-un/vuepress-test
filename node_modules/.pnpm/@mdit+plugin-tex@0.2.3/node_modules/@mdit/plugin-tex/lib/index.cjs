...
${s}
`:`
`)+e.getLines(t+1,c,e.tShift[t],!0)+(l!=null&&l.trim()?l:""),r.map=[t,e.line],r.markup="$$",!0},m=(e,t)=>{const{render:n}=t||{};if(typeof n!="function")throw new Error('[@mdit/plugin-tex]: "render" option should be a function');e.inline.ruler.after("escape","math_inline",h),e.block.ruler.after("blockquote","math_block",$,{alt:["paragraph","reference","blockquote","list"]}),e.renderer.rules.math_inline=(i,s)=>n(i[s].content,!1),e.renderer.rules.math_block=(i,s)=>n(i[s].content,!0)};exports.tex=m;
